...
class New extends Component  {
  render(){
    return (
          <Card as={Link} to={'/news/' + this.props.link } className={'shadow-sm hoverable'}>
            <Flex p={2} auto>
                <Box px={2} w={1/2} h={1} className={'box-image-area'} style={{minWidth: '28vh'}}>
                   <Card.Img className={'image-area'} alt="New" style={{ height: '25vh', width: '25vh'}} src={this.props.image} />
                </Box>
