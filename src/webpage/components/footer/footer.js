...
const Footer = () =>  {
  const iText1 = 'Global & Local Customers';
  const iText2 = 'Different Apis';
  const iText3 = 'Dedicated Employees';
  const iText4 = 'International Revenue';
  ...
  return (
    ...
    <Row style={{marginTop: '20px'}}>
          ...
          <IconCard text={iText3} color='#3e83d4' icon={faUsers} counter='800' addon='+'/>
