...
class NewEdit extends Component {
  ...
  componentDidMount(){
    ...
    data.then((result) => {
        this.setState({
            ...
            onLoadContent: result.content,
            image: result.image,
            file: null,
            date: null,
            onLoadDate: DateToDaily(result.date)
        })
    })
  }
  ...
  onPhotoFormSubmit(e){
    ...
    handleOnSubmit(event){
        ...
        agent.Aktiviteler.update(activity).then((response)=> {
          response.status === 200 ? 
      ...
      <Form style={{marginBottom: '40px'}}>
        {
          ...
          <Card.Group itemsPerRow={2}>
            <Card>
              <Card.Content>
                  ...
                  <Card.Header>
                    <Input
                        value={this.state.date ? this.state.date.toLocaleDateString() : this.state.onLoadDate}
          ...
          <Segment>
          <SunEditor  setContents={this.state.onLoadContent}
